...
public class DatabaseController{
    ...
    public DatabaseController(){
        ...
        try{
            /*
            DEBUG. Test for connection to mariadb database.
            */
            //connection string
            Connection connection = DriverManager.getConnection("jdbc:mariadb://localhost:3306/test?user=" + dbLogin + "&password=" + dbPass);
            ...
            ResultSetMetaData rsmd = rs.getMetaData(); //get the metadata of the ResultSet so we can loop through it
            statement.close(); //close the statement to prevent memory leaks.
            connection.close(); //ditto.
